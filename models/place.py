...
class Place(BaseModel, Base):
    ...
    if getenv('HBNB_TYPE_STORAGE') == 'db':
        ...
        city_id = Column(String(60), ForeignKey('cities.id', onupdate = 'CASCADE', ondelete = 'CASCADE'), nullable=False)
        ...
        __amenities = relationship("Amenity", secondary="place_amenity", backref="place_amenities", viewonly=False)
    else:
        city_id = ""
        user_id = ""
        name = ""
